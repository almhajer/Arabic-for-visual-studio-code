...
[![Install from VSIX](https://img.shields.io/badge/Download-Direct-blue)](https://marketplace.visualstudio.com/items?itemName=Arabic-language.vscode-ar)
...
```mermaid
graph LR
    A[Install Pack] --> B[Open VS Code]
    B --> C[Press Ctrl+Shift+P]
    C --> D[Type: display]
...
[![Official Documentation](https://img.shields.io/badge/Official-Documentation-blue)](https://go.microsoft.com/fwlink/?LinkId=761051)
...
| Link | Description |
|:----:|:-----------|
| [![https://almhajer.github.io/GraphicsProgrammingAtlas/](https://img.shields.io/badge/https://almhajer.github.io/GraphicsProgrammingAtlas/-blue)](https://almhajer.github.io/GraphicsProgrammingAtlas) | Official Website |
...
|:---------:|:-----------|:--------:|:----:|
| 🌐 **Arabic Language Pack** | Arabic Language Pack for VS Code | 0.0.16 | [VS Marketplace](https://marketplace.visualstudio.com/items?itemName=Arabic-language.vscode-ar) |
