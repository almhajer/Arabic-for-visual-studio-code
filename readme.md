...
![Version](https://img.shields.io/badge/version-0.0.13-blue?style=for-the-badge&logo=visual-studio-code)
...
|:-------:|:------|:-------:|:------:|
| 🌐 **Arabic Language Pack** | حزمة اللغة العربية لـ VS Code | 0.0.12 | [VS Marketplace](https://marketplace.visualstudio.com/items?itemName=Arabic-language.vscode-ar) |
